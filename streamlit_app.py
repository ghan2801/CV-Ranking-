...
def main():
    ...
    s1="C:\\Users\\ghanshyam.rajput\\Desktop\\DIPMLAI\\dataset\\dataset\\trainResumes\\"
    s = "C:\\Users\\ghanshyam.rajput\\Desktop\\DIPMLAI\\dataset\\dataset\\JDs\\"
    ...
    nor = st.number_input('Please enter how many resumes want to scan: ')
    nor =int(nor)
    for i in range(1,nor+1):
        print('Resume - ',i)
        #rpath = st.text_input('Path of resume: ')
        #uploaded_files = st.file_uploader("Choose files", accept_multiple_files=True)
        uploaded_file = st.file_uploader("Choose a file",key = i)
        rpath = uploaded_file.name
    ...
    jds = {}
    noj = st.number_input('Please enter how many JDs want to scan: ')
    noj =int(noj)
    for i in range(1,noj+1):
        #print('Resume - ',i)
        #rpath = st.text_input('Path of resume: ')
        #uploaded_files = st.file_uploader("Choose files", accept_multiple_files=True)
        uploaded_file = st.file_uploader("Choose a file",key = i+100)
        jpath = uploaded_file.name
